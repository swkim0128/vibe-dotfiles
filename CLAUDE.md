...
## 🛠️ 구조
- `tmux/`, `nvim/lua/` (NvChad), `vibe-tools/` (사용자 설정 데이터·overnight·issue-start), `zsh/aliases.zsh`, `ghostty/` (ghostty·cmux 테마/폰트 설정), `cmux/` (cmux 자체 설정 cmux.json), `docs/knowledge-base/` (KB SSoT)
